...
monthsBetween (Date dateA) (Date dateB) =
    case (dateA.month, dateB.month) of
        (Just month_A, Just month_B) ->
            let
                diferenta =
                    dateB.year - dateA.year

                month_d =
                    monthToInt month_B - monthToInt month_A

                totalMonths =
                    diferenta * 12 + month_d
            in
