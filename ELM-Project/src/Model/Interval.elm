...
import Model.Date exposing (Date)
        ...
        Interval { start, end } ->
            let
                ...
                intervalLength =
                    case end of
                        Just endDate ->
                            Model.Date.monthsBetween start endDate |> Maybe.map (\months -> text <| String.fromInt months)
            ...
            in
            div [ class intervalC ]
                [ div [] [ text "Start: ", startDate ]
                , div [] [ text "End: ", endDateView ]
                , div [ class "interval-length" ] [ intervalLength ]
                ]